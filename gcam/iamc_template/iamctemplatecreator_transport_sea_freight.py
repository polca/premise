...
def run_sea_freight(scenario_name):
    ...
    output_df = output_df[output_df["subsector"].str.contains("Ship")]
    input_df = input_df[input_df["mode"].str.contains("Ship")]
    ...
    input_df = format_for_iamc(
        ...
        scenario_name,
        "EJ/yr",
        "Final Energy|Transport|Freight|Sea|" + input_df["mode"] + "|" + input_df["technology"],
    )
    output_df = format_for_iamc(
        output_df,
        scenario_name,
        "million tkm/yr",
        "Distance|Transport|Freight|Sea|" + output_df["subsector"] + "|" + output_df["technology"],
    )
