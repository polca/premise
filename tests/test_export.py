...
def test_references():
    ref = load_references()
    assert ref["Ethanol from maize starch"]["source"] == "Cozzolino, F. Life Cycle Assessment of Biofuels in EU/CH, 2018."
    assert ref["Ethanol from maize starch"]["description"].startswith("Production of ethanol")
