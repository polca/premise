    ...
    def create_new_markets_high_voltage(self):
        ...
        for region in regions_set:
            for period in range(0, 60, 10):
                ...
                solar_amount = solar_amount.to_dataframe().drop("region", axis=1)[
                    "value"
                ]
                ...
                techs = [
                    (s.tag, i.item(0))
                    for i in electricity_mix_no_res_solar.coords["variables"]
                ]
                ...
                extensions[columns_to_transfer] = reduced_dataset[
                    columns_to_transfer
                ].values
                ...
                extensions = pd.concat(
                    [extensions, pd.DataFrame([new_exc, tloss_exc]).T]
                )
